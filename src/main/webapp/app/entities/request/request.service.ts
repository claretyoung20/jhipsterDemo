...
export class RequestService {
     ...
     */
    private convertItemFromServer(json: any): Request {
    ...
    private convert(request: Request): Request {
        ...
        copy.dateCreated = this.dateUtils.toDate(request.dateCreated);

        copy.dateClosed = this.dateUtils.toDate(request.dateClosed);
        return copy;
    }
}
