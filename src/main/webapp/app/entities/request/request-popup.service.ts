        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.requestService.find(id).subscribe((request) => {
                    request.dateCreated = this.datePipe
                        .transform(request.dateCreated, 'yyyy-MM-ddTHH:mm:ss');
                    request.dateClosed = this.datePipe
                        .transform(request.dateClosed, 'yyyy-MM-ddTHH:mm:ss');
