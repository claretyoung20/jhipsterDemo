...
public class EntityDemoApp {

    private static final Logger log = LoggerFactory.getLogger(EntityDemoApp.class);

    private final Environment env;

    public EntityDemoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes EntityDemo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EntityDemoApp.class);
